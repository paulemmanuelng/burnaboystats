...
- **"Love, Damini" (album), row 3: the peak's issue date is 2022-11-03, not the 2022-11-02 stamp** (added 26 Sep 2026). Issue 1480 carries `dateCreated` Wed 2022-11-02. It is the only peak issue whose stamp is not a Thursday; the next albums issue, id 1500, is Thu 2022-11-10. TurnTable's chart page prints week 44/2022 as "Oct 28th - Nov 3rd, 2022" (Wayback capture of turntablecharts.com/charts/2, 9 Nov 2022, pageProps id 1480). Every other peak here is dated to the Thursday that closes the printed Fri–Thu week, which equals `dateCreated` on those issues. So a dated peak for this row reads 2022-11-03. The peak (3) and the issue (1480) are unchanged. That issue is the "Nigeria Top 50 Albums", the albums chart's first-ever issue.

...
export const singleCharts: ChartRelease[] = [
  ...
  { title: "Dai Dai", credit: "Shakira & Burna Boy", year: 2026, entries: [
    ...
    { c: "CH", peak: 1, weeksAtPeak: 13, weeks: 16 }, { c: "NL", peak: 1, weeksAtPeak: 7, weeks: 15, note: "seven weeks at No.1, not consecutive - two from 20 June, then five from 25 July" }, { c: "SR", peak: 1, weeksAtPeak: 7, weeks: 10 }, { c: "CO", peak: 1, weeksAtPeak: 4, weeks: 10, note: "four weeks at No.1, consecutive - 27 June to 18 July 2026; the weeks figure is a floor, the row's counter read 10 on the 1 August issue before it left the free top 25 and Billboard gates ranks 26-100" }, { c: "AE", peak: 1, weeksAtPeak: 9, weeks: 14 }, { c: "AT", peak: 1, weeksAtPeak: 11, weeks: 15 }, { c: "BE", peak: 1, weeksAtPeak: 9, weeks: 14, note: "Wallonia #1 · Flanders #1 — the run figures are Wallonia's Ultratop 50" }, { c: "SK", peak: 1, weeksAtPeak: 8, weeks: 14, note: "eight weeks at No.1, not consecutive - weeks 26 and 27, then 30 to 35; No.2 in week 36, so the run at the top is final" }, { c: "DE", peak: 1, weeksAtPeak: 10, weeks: 15 }, { c: "LB", peak: 1 }, { c: "GR", peak: 1, weeksAtPeak: 6, weeks: 12, note: "six weeks at No.1, not consecutive - weeks 26, 27, 29 and 30, with a week at No.2 between; IFPI Greece then paused the chart over the summer and returned with a single combined 34 (31-34) edition, No.1, then No.1 again in week 35. That combined edition is ONE published chart covering four calendar weeks and IFPI's own weeks counter treats it as one - so this figure counts editions, not calendar weeks" }, { c: "AR", peak: 1, weeksAtPeak: 1, weeks: 11 }, { c: "FR", peak: 1, weeksAtPeak: 9, weeks: 15, note: "nine weeks at No.1, consecutive - SNEP's own weekly Top Singles, semaine 28 (10 juillet) through semaine 36 (4 septembre 2026), an unbroken La-Semaine-Derniere-1er chain. THE WEEKS FIGURE IS COUNTED, NOT PUBLISHED: SNEP prints no weeks-on-chart column, only La Semaine Derniere, so 15 is the number of consecutive SNEP issues the record appears in - semaine 22 (29 mai, debut at No.95) through semaine 36. Every other weeks figure in this file is stated by the owning body itself; this one is the exception and says so. Watch semaine 30 (24 juillet): SNEP titles the No.1 row DAI DAI (A CAPPELLA), credited to SHAKIRA alone, with no plain DAI DAI anywhere in that week's Top 200 - same chart entry, different metadata, and the one week that needed a judgement call" }, { c: "LU", peak: 1, weeksAtPeak: 8, weeks: 14 }, { c: "PT", peak: 1, weeksAtPeak: 8, weeks: 14 }, { c: "PA", peak: 1, weeksAtPeak: 5, note: "five weeks at No.1, not consecutive - 11 and 18 June, then 2, 9 and 23 July, with a week at No.2 on 25 June; PRODUCE published no Top 50 Internacional for the 16 July week" }, { c: "SE", peak: 1, weeksAtPeak: 7, weeks: 16, note: "seven weeks at No.1, not consecutive - weeks 28-32, then 34 and 35" }, { c: "IT", peak: 1, weeksAtPeak: 4, weeks: 12 }, { c: "IN", peak: 1, weeksAtPeak: 1, weeks: 11 }, { c: "CZ", peak: 1, weeksAtPeak: 3, weeks: 13 }, { c: "IS", peak: 1, note: "Billboard Iceland Songs" }, { c: "VE", peak: 1, weeksAtPeak: 1, weeks: 11 }, { c: "NO", peak: 1, weeksAtPeak: 4 }, { c: "EC", peak: 1 }, { c: "EE", peak: 1 }, { c: "PL", peak: 1, weeksAtPeak: 1, weeks: 13 }, { c: "GLB", peak: 1, weeksAtPeak: 7, weeks: 14, note: "seven weeks at No.1, not consecutive - it fell to No.3 in the 15 August issue and retook the top the following week" }, { c: "GLBX", peak: 1, weeksAtPeak: 10, weeks: 15 },
    { c: "UK", peak: 2, weeksAtPeak: 5, weeks: 14 }, { c: "ES", peak: 2 }, { c: "UY", peak: 2 }, { c: "PR", peak: 2 },

...
export const CHART_COUNTRIES: Record<string, ChartCountry> = {
  ...
  IL: { name: "Israel", flag: "🇮🇱", body: "Media Forest" },
...
export const featureCharts: ChartRelease[] = [
  ...
  { title: "Dai Dai", credit: "Shakira ft. Burna Boy", year: 2026, entries: [
    ...
    { c: "AE", peak: 4 }, { c: "BE", peak: 4 }, { c: "SE", peak: 5 }, { c: "CO", peak: 8 }, { c: "SA", peak: 8 }, { c: "ES", peak: 10 }, { c: "AR", peak: 20 }, { c: "UK", peak: 28 },
  ...
  { title: "We Pray", credit: "Coldplay ft. Little Simz, Burna Boy, Elyanna & TINI", year: 2024, entries: [
    { c: "HR", peak: 3 }, { c: "NL", peak: 4 }, { c: "HK", peak: 4 }, { c: "IE", peak: 7 }, { c: "AE", peak: 8 },
    { c: "BE", peak: 9 }, { c: "IL", peak: 10 }, { c: "UK", peak: 20 }, { c: "IN", peak: 20 }, { c: "NZ", peak: 21 },
    { c: "CH", peak: 22 }, { c: "AT", peak: 28 }, { c: "IS", peak: 30 }, { c: "AR", peak: 36 }, { c: "AU", peak: 37 },

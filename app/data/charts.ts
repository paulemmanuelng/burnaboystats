...
export const CHART_COUNTRIES: Record<string, ChartCountry> = {
  ...
  IL: { name: "Israel", flag: "🇮🇱", body: "Official Top 100 Singles" },
...
export const featureCharts: ChartRelease[] = [
  ...
  { title: "Dai Dai", credit: "Shakira ft. Burna Boy", year: 2026, entries: [
    ...
    { c: "UK", peak: 5 }, { c: "IE", peak: 14 }, { c: "EG", peak: 14 }, { c: "CA", peak: 16 }, { c: "DK", peak: 17 }, { c: "MY", peak: 17 }, { c: "IL", peak: 13 }, { c: "SG", peak: 20 }, { c: "HU", peak: 26 }, { c: "AU", peak: 32 }, { c: "FI", peak: 35 },
    { c: "BR", peak: 39 }, { c: "US", peak: 42 },
    { c: "JP", peak: 60 }, { c: "VN", peak: 93 },
  ], note: "No.1 on both Billboard global charts — a 2nd week atop the Global 200 and a 4th week atop the Global 200 Excl. US. Also No.1 on Billboard's US World Digital Song Sales chart, No.2 on Middle East & North Africa and No.12 on North Africa, plus No.1 on the Official MENA Chart's Top 20." },

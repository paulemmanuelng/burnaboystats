...
export const featureCharts: ChartRelease[] = [
  ...
  ], note: "No.1 on both Billboard global charts — a 2nd week atop the Global 200 and a 4th week atop the Global 200 Excl. US. Also on Billboard's other multi-territory charts: No.1 Central America & Caribbean, No.2 Middle East & North Africa and No.12 North Africa, plus No.1 on the Official MENA Chart's Top 20." },

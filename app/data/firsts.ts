...
export const firstGroups: FirstGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { year: "2026", title: "First African artist with a music video past 500 million YouTube views", text: "The “Dai Dai” video (with Shakira) crossed 500 million views in under two months — Burna Boy's first music video to reach the mark, and the world's most-viewed music video of 2026." },
      ...
      { year: "2026", title: "First African artist to surpass 700 million YouTube Music monthly audience", text: "Burna Boy's monthly audience on YouTube Music passed 700 million in July 2026 — now 747 million, a first for any African artist, and the seventh-biggest audience ever recorded worldwide, having just passed Michael Jackson (741M)." },

...
export const firstGroups: FirstGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { year: "2026", title: "First African artist to surpass 700 million YouTube Music monthly audience", text: "Burna Boy's monthly audience on YouTube Music passed 700 million in July 2026 — now 784 million, a first for any African artist, and the seventh-biggest audience ever recorded worldwide, above Michael Jackson (741M)." },

...
export const firstGroups: FirstGroup[] = [
  {
    ...
    items: [
      ...
      { year: "2021", title: "First African artist to sell out the Ziggo Dome", text: "The Netherlands' biggest entertainment venue (17,000 capacity), on the Space Drift World Tour — Ziggo presented him a plaque marking the milestone." },

...
export const tours: Tour[] = [
  ...
  },
  {
    ...
    years: "2022–23",
    gross: "$11.8M",
    note: "The breakthrough run behind the album — off the back of his Madison Square Garden debut, it made him the first African artist to headline a UK stadium (London Stadium) and to sell out a US stadium (Citi Field). Eight reported shows grossed roughly $11.8M.",
    dates: [

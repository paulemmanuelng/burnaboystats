// GENERATED FILE — do not edit by hand.
  // Appended to by scripts/build-live-charts.mjs --artist=black-sherif on every sweep.
  //
  // The long memory of Black Sherif's WORLDWIDE chart positions. The live
  ...
  // (the day's latest reading). Collection began 2026-08-30;

...
export const afrobeatsArtists: AfroArtist[] = [
  {
    ...
    country: "Nigeria",
    flag: "🇳🇬",
    hook: "Ninety-nine charted records in Nigeria — the deepest home catalogue on this board, and more than anyone else has put on the chart.",
  ...
  },
  {
    ...
    country: "Nigeria",
    flag: "🇳🇬",
    hook: "Eighty plaques and 24 Nigerian No. 1s — the deepest home-chart record on this board.",

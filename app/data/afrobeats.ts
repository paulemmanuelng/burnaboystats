...
export const afrobeatsArtists: AfroArtist[] = [
  ...
  },
  {
    ...
    releases: [
      ...
      // POLAND IS 1x PLATINUM, not 3x (23 Sep 2026). The 3x was Wikipedia-cited
      // while ZPAV's register was unreachable; read at the body (POST
      // olis.pl/api/search, category 3, Platynowe Płyty, contractor "Drake"), the
      // register holds ONE row — "ONE DANCE | singiel", Platinum, 11 Aug 2021 — and
      // no Gold or Diamond. It files every step of a multiple as its own row
      // (love nwantiti has four), so one row is 1x. It mattered from the day
      // Poland's singles were priced: 3x would have added 250,000 units ZPAV
      // never awarded.
      { title: "One Dance", kind: "Featured appearances", cover: "https://cdn-images.dzcdn.net/images/cover/56bdb7a86a27fadb96332c0c8f1b8e81/500x500-000000-80-0-0.jpg", certs: [{ c: "US", level: "Diamond" }, { c: "CA", level: "Diamond" }, { c: "DE", level: "Diamond" }, { c: "FR", level: "Diamond" }, { c: "BR", level: "Diamond" }, { c: "AU", level: "Platinum", x: 17 }, { c: "NZ", level: "Platinum", x: 10 }, { c: "UK", level: "Platinum", x: 8 }, { c: "PT", level: "Platinum", x: 8 }, { c: "SE", level: "Platinum", x: 7 }, { c: "IT", level: "Platinum", x: 6 }, { c: "ES", level: "Platinum", x: 5 }, { c: "DK", level: "Platinum", x: 5 }, { c: "MX", level: "Platinum", x: 4 }, { c: "BE", level: "Platinum", x: 3 }, { c: "PL", level: "Platinum" }, { c: "GR", level: "Platinum", x: 3 }] },

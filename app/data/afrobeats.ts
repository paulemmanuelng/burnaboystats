...
export const afrobeatsArtists: AfroArtist[] = [
  {
    ...
    charts: [
      ...
      { title: "LOML", kind: "Singles", entries: [{ c: "NG", peak: 15 }] },
      ...
      { title: "Bigger", kind: "Singles", entries: [{ c: "NG", peak: 35 }] },
  ...
  },
  {
    ...
    charts: [
      ...
      { title: "YARD", kind: "Singles", entries: [{ c: "NG", peak: 45 }] },
  ...
  },
  {
    ...
    releases: [
      ...
      { title: "Ilashe", kind: "Lead singles", certs: [{ c: "NG", level: "Platinum" }] },
    ...
    charts: [
      ...
      { title: "Ilashe", kind: "Singles", entries: [{ c: "NG", peak: 9 }] },
      ...
      { title: "What's Poppin'", kind: "Singles", entries: [{ c: "NG", peak: 70 }] },
      ...
      { title: "Oil", kind: "Singles", entries: [{ c: "NG", peak: 81 }] },
      ...
      { title: "Not Done", kind: "Singles", entries: [{ c: "NG", peak: 90 }] },
      ...
      { title: "WHO THIS", kind: "Singles", entries: [{ c: "NG", peak: 24, note: "Peak still open — read in the release's first weeks on the Top 100, so it may yet climb. Re-read in a later capture." }] }, // TurnTable week 37: rank 24, highestPosition 24, 3 weeks (read 17 Sep 2026)
  ...
  },
  {
    ...
    charts: [
      ...
      { title: "IDK", kind: "Singles", entries: [{ c: "NG", peak: 2 }] },
      { title: "Billionaires Club", kind: "Singles", entries: [{ c: "NG", peak: 2 }] },
      { title: "Getting Paid", kind: "Singles", entries: [{ c: "NG", peak: 2 }] },
      { title: "Reckless", kind: "Singles", entries: [{ c: "NG", peak: 3 }] },
      { title: "Kai!", kind: "Singles", entries: [{ c: "NG", peak: 3 }] },
      { title: "BIG TIME", kind: "Singles", entries: [{ c: "NG", peak: 3 }] },
      { title: "Alaye", kind: "Singles", entries: [{ c: "NG", peak: 3 }] },
      { title: "No Stress", kind: "Singles", entries: [{ c: "NG", peak: 4 }] },
      { title: "Money & Love", kind: "Singles", entries: [{ c: "NG", peak: 4 }] },
      { title: "Ololufe", kind: "Singles", entries: [{ c: "NG", peak: 4 }] },
      { title: "Iskolodo", kind: "Singles", entries: [{ c: "NG", peak: 5 }] },
      { title: "Troubled Mind", kind: "Singles", entries: [{ c: "NG", peak: 5 }] },
      { title: "Abracadabra (Remix)", kind: "Singles", entries: [{ c: "NG", peak: 6 }] },
      { title: "Bend", kind: "Singles", entries: [{ c: "NG", peak: 7 }] },
      { title: "IDG", kind: "Singles", entries: [{ c: "NG", peak: 8 }] },
      { title: "STATE OF MIND", kind: "Singles", entries: [{ c: "NG", peak: 8 }] },
      { title: "Diamonds", kind: "Singles", entries: [{ c: "NG", peak: 9 }] },
      { title: "EASY WITH ME", kind: "Singles", entries: [{ c: "NG", peak: 9 }] },
      { title: "Karamo", kind: "Singles", entries: [{ c: "NG", peak: 9 }] },
      { title: "Blessed", kind: "Singles", entries: [{ c: "NG", peak: 10 }] },
      { title: "Pray", kind: "Singles", entries: [{ c: "NG", peak: 10 }] },
      { title: "Time", kind: "Singles", entries: [{ c: "NG", peak: 11 }] },
      { title: "Mood (Wizkid ft. BNXN)", kind: "Singles", entries: [{ c: "NG", peak: 12 }] },
      { title: "PAMI", kind: "Singles", entries: [{ c: "NG", peak: 12 }] },
      { title: "Longtime", kind: "Singles", entries: [{ c: "NG", peak: 12 }] },
      { title: "One Love (Bob Marley: One Love)", kind: "Singles", entries: [{ c: "NG", peak: 12 }] },
      { title: "A Million Blessings", kind: "Singles", entries: [{ c: "NG", peak: 12 }] },
      { title: "Like That (bomboclatt)", kind: "Singles", entries: [{ c: "NG", peak: 12 }] },
      { title: "Smile", kind: "Singles", entries: [{ c: "NG", peak: 13 }] },
      { title: "Apres Minuit", kind: "Singles", entries: [{ c: "NG", peak: 13 }] },
      { title: "Wow", kind: "Singles", entries: [{ c: "NG", peak: 15 }] },
      { title: "Apala Disco (Remix)", kind: "Singles", entries: [{ c: "NG", peak: 15 }] },
      { title: "Break Me Down", kind: "Singles", entries: [{ c: "NG", peak: 15 }] },
      { title: "Loju", kind: "Singles", entries: [{ c: "NG", peak: 17 }] },
      { title: "Soji", kind: "Singles", entries: [{ c: "NG", peak: 17 }] },
      { title: "Anoti", kind: "Singles", entries: [{ c: "NG", peak: 18 }] },
      { title: "Many Ways", kind: "Singles", entries: [{ c: "NG", peak: 18 }] },
      { title: "True Love", kind: "Singles", entries: [{ c: "NG", peak: 19 }] },
      { title: "Balance", kind: "Singles", entries: [{ c: "NG", peak: 19 }] },
      { title: "Bad For You", kind: "Singles", entries: [{ c: "NG", peak: 19 }] },
      { title: "Situation", kind: "Singles", entries: [{ c: "NG", peak: 19 }] },
      { title: "Ebelebe", kind: "Singles", entries: [{ c: "NG", peak: 20 }] },
      { title: "Mighty Wine", kind: "Singles", entries: [{ c: "NG", peak: 20 }] },
      { title: "Slow", kind: "Singles", entries: [{ c: "NG", peak: 20 }] },
      { title: "Piece of Me", kind: "Singles", entries: [{ c: "NG", peak: 21 }] },
      { title: "Don't Care", kind: "Singles", entries: [{ c: "NG", peak: 21 }] },
      { title: "Everyday", kind: "Singles", entries: [{ c: "NG", peak: 22 }] },
      { title: "Roma", kind: "Singles", entries: [{ c: "NG", peak: 23 }] },
      { title: "Lose", kind: "Singles", entries: [{ c: "NG", peak: 25 }] },
      { title: "Nights In The Sun", kind: "Singles", entries: [{ c: "NG", peak: 25 }] },
      { title: "Sweet One", kind: "Singles", entries: [{ c: "NG", peak: 27 }] },
      { title: "Flower Pads", kind: "Singles", entries: [{ c: "NG", peak: 28 }] },
      { title: "Grace", kind: "Singles", entries: [{ c: "NG", peak: 30 }] },
      { title: "Slip N Slide", kind: "Singles", entries: [{ c: "NG", peak: 31 }] },
      { title: "LV N ATTN", kind: "Singles", entries: [{ c: "NG", peak: 32 }] },
      { title: "Frames (Who's Gonna Know)", kind: "Singles", entries: [{ c: "NG", peak: 32 }] },
      { title: "Gyrate", kind: "Singles", entries: [{ c: "NG", peak: 34 }] },
      { title: "Pressure", kind: "Singles", entries: [{ c: "NG", peak: 39 }] },
      { title: "ABANGANI", kind: "Singles", entries: [{ c: "NG", peak: 39 }] },
      { title: "Deep", kind: "Singles", entries: [{ c: "NG", peak: 40 }] },
      { title: "Jam", kind: "Singles", entries: [{ c: "NG", peak: 40 }] },
      { title: "Blessings", kind: "Singles", entries: [{ c: "NG", peak: 42 }] },
      { title: "Plenty Loving", kind: "Singles", entries: [{ c: "NG", peak: 42 }] },
      { title: "Special", kind: "Singles", entries: [{ c: "NG", peak: 44 }] },
      { title: "Work Me Out", kind: "Singles", entries: [{ c: "NG", peak: 46 }] },
      { title: "Majo", kind: "Singles", entries: [{ c: "NG", peak: 47 }] },
      { title: "Awolowo", kind: "Singles", entries: [{ c: "NG", peak: 48 }] },
      { title: "Stay For The Night", kind: "Singles", entries: [{ c: "NG", peak: 56 }] },
      { title: "Slow Motion", kind: "Singles", entries: [{ c: "NG", peak: 61 }] },
      { title: "FIESTA", kind: "Singles", entries: [{ c: "NG", peak: 71 }] },
      { title: "Lighter", kind: "Singles", entries: [{ c: "NG", peak: 72 }] },
      { title: "Anxious", kind: "Singles", entries: [{ c: "NG", peak: 86 }] },
      { title: "Ojuelegba", kind: "Singles", entries: [{ c: "NG", peak: 92 }] },
  ...
  },
  {
    ...
    releases: [
      ...
      { title: "Hmmm", kind: "Featured appearances", certs: [{ c: "NG", level: "Platinum" }] },
    ...
    charts: [
      ...
      { title: "Somebody Baby (Peruzzi ft. Davido)", kind: "Singles", entries: [{ c: "NG", peak: 2 }] },
      { title: "High (Adekunle Gold ft. Davido)", kind: "Singles", entries: [{ c: "NG", peak: 2 }] },
      { title: "Jowo", kind: "Singles", entries: [{ c: "NG", peak: 3 }] },
      { title: "Stand Strong (ft. Sunday Service Choir)", kind: "Singles", entries: [{ c: "NG", peak: 6 }] },
      { title: "So Crazy (ft. Lil Baby)", kind: "Singles", entries: [{ c: "NG", peak: 7 }] },
      { title: "Dada (Remix) (Young Jonn ft. Davido)", kind: "Singles", entries: [{ c: "NG", peak: 7 }] },
      { title: "Shopping Spree (ft. Chris Brown & Young Thug)", kind: "Singles", entries: [{ c: "NG", peak: 8 }] },
      { title: "Champion Sound (Davido & Focalistic)", kind: "Singles", entries: [{ c: "NG", peak: 8 }] },
      { title: "Something Fishy", kind: "Singles", entries: [{ c: "NG", peak: 9 }] },
      { title: "La La (ft. Ckay)", kind: "Singles", entries: [{ c: "NG", peak: 10 }] },
      ...
      { title: "Heaven", kind: "Singles", entries: [{ c: "NG", peak: 12 }] },
      { title: "Cho Cho (Zlatan ft. Mayorkun & Davido)", kind: "Singles", entries: [{ c: "NG", peak: 12 }] },
      { title: "Maserati (Remix) (Olakira ft. Davido)", kind: "Singles", entries: [{ c: "NG", peak: 13 }] },
      { title: "Ke Star (Remix) (Focalistic & Davido ft. Virgo Deep)", kind: "Singles", entries: [{ c: "NG", peak: 15 }] },
      { title: "Tanana (ft. Tiwa Savage)", kind: "Singles", entries: [{ c: "NG", peak: 16 }] },
      { title: "Very Special", kind: "Singles", entries: [{ c: "NG", peak: 18 }] },
      { title: "Fade (ft. Bella Shmurda)", kind: "Singles", entries: [{ c: "NG", peak: 19 }] },
      { title: "Holy Water", kind: "Singles", entries: [{ c: "NG", peak: 19 }] },
      { title: "Sunlight", kind: "Singles", entries: [{ c: "NG", peak: 21 }] },
      { title: "Showing Off Her Body (DaBaby & Davido)", kind: "Singles", entries: [{ c: "NG", peak: 21 }] },
      { title: "Bop (ft. Dexta Daps)", kind: "Singles", entries: [{ c: "NG", peak: 21 }] },
      { title: "Mebe (ft. Mugeez)", kind: "Singles", entries: [{ c: "NG", peak: 23 }] },
      { title: "Precision", kind: "Singles", entries: [{ c: "NG", peak: 23 }] },
      { title: "U (Juju) (ft. Skepta)", kind: "Singles", entries: [{ c: "NG", peak: 24 }] },
      { title: "CFMF", kind: "Singles", entries: [{ c: "NG", peak: 24 }] },
      { title: "Picasso (ft. Logos Olori)", kind: "Singles", entries: [{ c: "NG", peak: 26 }] },
      { title: "Birthday Cake (ft. Nas & Hit-Boy)", kind: "Singles", entries: [{ c: "NG", peak: 27 }] },
      { title: "Pepe (L.A.X ft. Davido)", kind: "Singles", entries: [{ c: "NG", peak: 27 }] },
      { title: "LCND", kind: "Singles", entries: [{ c: "NG", peak: 27 }] },
      { title: "I Got a Friend (ft. Mayorkun & Sho Majodzi)", kind: "Singles", entries: [{ c: "NG", peak: 28 }] },
      { title: "Activate (Stonebwoy ft. Davido)", kind: "Singles", entries: [{ c: "NG", peak: 28 }] },
      { title: "R&B (ft. Shenseea & 450)", kind: "Singles", entries: [{ c: "NG", peak: 28 }] },
      { title: "Titanium (ft. Chris Brown)", kind: "Singles", entries: [{ c: "NG", peak: 30 }] },
      { title: "Hip Hop Messiah (Zlatan ft. Davido)", kind: "Singles", entries: [{ c: "NG", peak: 31 }] },
      { title: "On My Way (ft. Sauti Sol)", kind: "Singles", entries: [{ c: "NG", peak: 32 }] },
      { title: "Don't Know", kind: "Singles", entries: [{ c: "NG", peak: 33 }] },
      { title: "Betty Butter (Mayorkun ft. Davido)", kind: "Singles", entries: [{ c: "NG", peak: 34 }] },
      { title: "Mandeman (Remix) (Small Doctor ft. Davido)", kind: "Singles", entries: [{ c: "NG", peak: 37 }] },
      { title: "Five By Alhanislam", kind: "Singles", entries: [{ c: "NG", peak: 37 }] },
      { title: "Nuttin Dey", kind: "Singles", entries: [{ c: "NG", peak: 38 }] },
      { title: "Lately", kind: "Singles", entries: [{ c: "NG", peak: 40 }] },
      { title: "This Your Body (Skales ft. Davido)", kind: "Singles", entries: [{ c: "NG", peak: 43 }] },
      { title: "Drift (Remix) (Teejay & Davido)", kind: "Singles", entries: [{ c: "NG", peak: 46 }] },
      { title: "Lover Boy (ft. Tayc & Dadju)", kind: "Singles", entries: [{ c: "NG", peak: 49 }] },
      { title: "Tek (ft. Becky G)", kind: "Singles", entries: [{ c: "NG", peak: 50 }] },
      { title: "Bad Habits (King Promise & Davido)", kind: "Singles", entries: [{ c: "NG", peak: 73 }] },
      { title: "Bum Bum (PaBrymo ft. Davido)", kind: "Singles", entries: [{ c: "NG", peak: 85 }] },
      { title: "Easy On Me (Logos Olori & Davido)", kind: "Singles", entries: [{ c: "NG", peak: 86 }] },
  ...
  },
  {
    ...
    charts: [
      ...
      { title: "TEA", kind: "Singles", entries: [{ c: "NG", peak: 3, note: "Peak still open — read in the release's first weeks on the Top 100, so it may yet climb. Re-read in a later capture." }] },
  ...
  },
  {
    ...
    charts: [
      ...
      { title: "Girl Next Door", kind: "Singles", entries: [{ c: "NG", peak: 73 }] },
      { title: "Show Me Love", kind: "Singles", entries: [{ c: "NG", peak: 59 }] },
      { title: "No.1", kind: "Singles", entries: [{ c: "NG", peak: 79 }] },
      { title: "Breathe Me", kind: "Singles", entries: [{ c: "NG", peak: 89 }] },
      ...
      { title: "Is It Love", kind: "Singles", entries: [{ c: "ZA", peak: 17 }] },
      { title: "Double Blind", kind: "Singles", entries: [{ c: "ZA", peak: 19 }] },
      { title: "Mr. Nonchalant", kind: "Singles", entries: [{ c: "ZA", peak: 20 }] },
      { title: "WWP", kind: "Albums", entries: [{ c: "NG", peak: 18 }] },
  ...
  },
  {
    ...
    charts: [
      ...
      { title: "Ngozi", kind: "Singles", entries: [{ c: "NG", peak: 2 }] },
      { title: "People", kind: "Singles", entries: [{ c: "NG", peak: 6 }] },
      { title: "Love Don't Cost A Dime (Re-Up)", kind: "Singles", entries: [{ c: "NG", peak: 8 }] },
      { title: "PINACOLADA", kind: "Singles", entries: [{ c: "NG", peak: 15 }] },
      { title: "Beggie Beggie", kind: "Singles", entries: [{ c: "NG", peak: 26 }] },
      { title: "Alle", kind: "Singles", entries: [{ c: "NG", peak: 29 }] },
      { title: "How Many Times", kind: "Singles", entries: [{ c: "NG", peak: 30 }] },
      { title: "Running", kind: "Singles", entries: [{ c: "NG", peak: 34 }] },
      { title: "Escaladizzy II", kind: "Singles", entries: [{ c: "NG", peak: 34 }] },
      { title: "Disturbing U", kind: "Singles", entries: [{ c: "NG", peak: 36 }] },
      { title: "Amina", kind: "Singles", entries: [{ c: "NG", peak: 45 }] },
      { title: "Many Roads", kind: "Singles", entries: [{ c: "NG", peak: 47 }] },
      { title: "Woman Commando", kind: "Singles", entries: [{ c: "NG", peak: 56 }] },
      { title: "On A Low", kind: "Singles", entries: [{ c: "NG", peak: 62 }] },
      { title: "Make It Up To You", kind: "Singles", entries: [{ c: "NG", peak: 65 }] },
      { title: "Bloody Samaritan (Remix)", kind: "Singles", entries: [{ c: "NG", peak: 66 }] },
      { title: "Amazing", kind: "Singles", entries: [{ c: "NG", peak: 70 }] },
      { title: "Girl Next Door", kind: "Singles", entries: [{ c: "NG", peak: 73 }] },
      { title: "Birds Sing of Money", kind: "Singles", entries: [{ c: "NG", peak: 74 }] },
      { title: "Control", kind: "Singles", entries: [{ c: "NG", peak: 81 }] },
      { title: "Misunderstood", kind: "Singles", entries: [{ c: "NG", peak: 86 }] },
      { title: "Jane", kind: "Singles", entries: [{ c: "NG", peak: 94 }] },
      { title: "Lonely Refix", kind: "Singles", entries: [{ c: "NG", peak: 95 }] },
      { title: "Midnight in New York", kind: "Singles", entries: [{ c: "NG", peak: 95 }] },
      { title: "Lagos Love Story", kind: "Singles", entries: [{ c: "NG", peak: 99 }] },
  ...
  },
  {
    ...
    charts: [
      ...
      { title: "Gut Genug", kind: "Singles", entries: [{ c: "NG", peak: 24 }] },
  ...
  },
  {
    ...
    charts: [
      ...
      { title: "BACK 2 U", kind: "Singles", entries: [{ c: "NG", peak: 8, note: "Peak still open — read in the release's first weeks on the Top 100, so it may yet climb. Re-read in a later capture." }] },
  ...
  },
  {
    ...
    charts: [
      ...
      { title: "TWIN", kind: "Singles", entries: [{ c: "NG", peak: 18, note: "Peak still open — read in the release's first weeks on the Top 100, so it may yet climb. Re-read in a later capture." }] }, // TurnTable week 37: rank 18, highestPosition 18, 3 weeks (read 17 Sep 2026)
  ...
  },
  {
    ...
    charts: [
      ...
      { title: "SHEGE", kind: "Singles", entries: [{ c: "NG", peak: 50, note: "Peak still open — read in the release's first weeks on the Top 100, so it may yet climb. Re-read in a later capture." }] },

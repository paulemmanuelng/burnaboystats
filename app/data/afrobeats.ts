...
export const afrobeatsArtists: AfroArtist[] = [
  {
    ...
    releases: [
      ...
      { title: "Joro", kind: "Lead singles", cover: "https://is1-ssl.mzstatic.com/image/thumb/Music113/v4/20/05/17/200517ab-c3a3-b833-74b3-9bb3399c780c/886447834886.jpg/300x300bb.jpg", certs: [{ c: "NG", level: "Platinum", x: 2 }, { c: "FR", level: "Platinum" }, { c: "CH", level: "Platinum" }, { c: "BE", level: "Gold" }, { c: "US", level: "Gold" }, { c: "CA", level: "Gold" }, { c: "UK", level: "Silver" }] },
  ...
  },
  {
    ...
    releases: [
      ...
      { title: "Ama", kind: "Lead singles", certs: [{ c: "NG", level: "Gold" }] },
    ...
    charts: [
      ...
      { title: "AMA", kind: "Singles", entries: [{ c: "NG", peak: 4 }] },
  ...
  },
  {
    ...
    country: "Nigeria",
    flag: "🇳🇬",
    hook: "Three countries have certified him, and all three did it for the same record — “Soweto”.",
  ...
  },
  {
    ...
    swept: true,
    chartPublished: { entries: 28, territories: 19, no1s: 5 },
    releases: [

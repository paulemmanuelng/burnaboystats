...
export const afrobeatsArtists: AfroArtist[] = [
  {
    ...
    releases: [
      ...
      { title: "Infinity", kind: "Lead singles", certs: [{ c: "NG", level: "Platinum", x: 3 }, { c: "UK", level: "Silver" }] },
      { title: "Omo Ope", kind: "Featured appearances", certs: [{ c: "NG", level: "Platinum", x: 3 }] },
      ...
      { title: "Triumphant", kind: "Lead singles", certs: [{ c: "NG", level: "Platinum", x: 2 }] },
      { title: "Billionaires Club", kind: "Lead singles", certs: [{ c: "NG", level: "Platinum" }] },
      { title: "Free", kind: "Lead singles", certs: [{ c: "NG", level: "Platinum" }] },
      { title: "Gaza", kind: "Lead singles", certs: [{ c: "NG", level: "Platinum" }] },
      ...
      { title: "Loading", kind: "Lead singles", certs: [{ c: "NG", level: "Platinum" }] },
      ...
      { title: "Uptown Disco", kind: "Lead singles", certs: [{ c: "NG", level: "Platinum" }] },
      ...
      { title: "Synchro System", kind: "Lead singles", certs: [{ c: "NG", level: "Gold" }] },
      { title: "Trumpet (Olamide & CKay)", kind: "Lead singles", certs: [{ c: "NG", level: "Gold" }] },
      ...
      { title: "Zazoo Zehh", kind: "Featured appearances", certs: [{ c: "NG", level: "Gold" }] },
      { title: "Another Level", kind: "Lead singles", certs: [{ c: "NG", level: "Silver" }] },
      ...
      { title: "Come Alive", kind: "Lead singles", certs: [{ c: "NG", level: "Silver" }] },
      ...
      { title: "Doom", kind: "Lead singles", certs: [{ c: "NG", level: "Silver" }] },
      ...
      { title: "Mukulu (Olamide & Rema)", kind: "Lead singles", certs: [{ c: "NG", level: "Silver" }] },
      ...
      { title: "Problem", kind: "Lead singles", certs: [{ c: "NG", level: "Silver" }] },
      { title: "Shibebe", kind: "Lead singles", certs: [{ c: "NG", level: "Silver" }] },
      ...
      { title: "Street Jam", kind: "Lead singles", certs: [{ c: "NG", level: "Silver" }] },
    ...
    charts: [
      ...
      { title: "Infinity", kind: "Singles", entries: [{ c: "NG", peak: 2 }] },
      ...
      { title: "Triumphant", kind: "Singles", entries: [{ c: "NG", peak: 3 }] },
      ...
      { title: "Loading", kind: "Singles", entries: [{ c: "NG", peak: 5 }] },
      ...
      { title: "Uptown Disco", kind: "Singles", entries: [{ c: "NG", peak: 6 }] },
      { title: "ZaZoo Zehh", kind: "Singles", entries: [{ c: "NG", peak: 6 }] },
      ...
      { title: "Gaza", kind: "Singles", entries: [{ c: "NG", peak: 10 }] },
      ...
      { title: "Free", kind: "Singles", entries: [{ c: "NG", peak: 13 }] },
      ...
      { title: "Synchro System", kind: "Singles", entries: [{ c: "NG", peak: 14 }] },
      { title: "LOML", kind: "Singles", entries: [{ c: "NG", peak: 15 }] },
      { title: "Trumpet (Olamide & CKay)", kind: "Singles", entries: [{ c: "NG", peak: 15 }] },
      ...
      { title: "Doom", kind: "Singles", entries: [{ c: "NG", peak: 28 }] },
      ...
      { title: "Mukulu (Olamide & Rema)", kind: "Singles", entries: [{ c: "NG", peak: 32 }] },
      ...
      { title: "Problem", kind: "Singles", entries: [{ c: "NG", peak: 37 }] },
      ...
      { title: "Street Jam", kind: "Singles", entries: [{ c: "NG", peak: 43 }] },
      ...
      { title: "Shibebe", kind: "Singles", entries: [{ c: "NG", peak: 48 }] },
      ...
      { title: "No Worries", kind: "Singles", entries: [{ c: "NG", peak: 60 }] },
      ...
      { title: "Supplier", kind: "Singles", entries: [{ c: "NG", peak: 62 }] },
      { title: "Hardcore", kind: "Singles", entries: [{ c: "NG", peak: 64 }] },
      { title: "Life Goes On", kind: "Singles", entries: [{ c: "NG", peak: 65 }] },
  ...
  },
  {
    ...
    releases: [
      ...
      { title: "The Homeless Song", kind: "Lead singles", certs: [{ c: "NG", level: "Silver" }] },
    ...
    charts: [
      ...
      { title: "Amazing Grace", kind: "Singles", entries: [{ c: "NG", peak: 20 }] },
  ...
  },
  {
    ...
    releases: [
      ...
      { title: "I Alone", kind: "Lead singles", certs: [{ c: "NG", level: "Platinum" }] },
      ...
      { title: "Mood (Wizkid ft. BNXN)", kind: "Featured appearances", certs: [{ c: "NG", level: "Platinum" }, { c: "US", level: "Gold" }, { c: "UK", level: "Silver" }, { c: "CA", level: "Gold" }, { c: "NZ", level: "Gold" }] },
      ...
      { title: "Set Up", kind: "Lead singles", certs: [{ c: "NG", level: "Platinum" }] },
      { title: "5Hrs Till Nairobi", kind: "Lead singles", certs: [{ c: "NG", level: "Gold" }] },
      ...
      { title: "Jies", kind: "Lead singles", certs: [{ c: "NG", level: "Gold" }] },
      ...
      { title: "Captain", kind: "Lead singles", certs: [{ c: "NG", level: "Silver" }] },
      ...
      { title: "Come Alive", kind: "Lead singles", certs: [{ c: "NG", level: "Silver" }] },
      { title: "Cough Syrup", kind: "Lead singles", certs: [{ c: "NG", level: "Silver" }] },
      { title: "Cutesy", kind: "Lead singles", certs: [{ c: "NG", level: "Silver" }] },
      { title: "Eleyi", kind: "Lead singles", certs: [{ c: "NG", level: "Silver" }] },
    ...
    charts: [
      ...
      { title: "Set Up", kind: "Singles", entries: [{ c: "NG", peak: 26 }] },
      ...
      { title: "Jies", kind: "Singles", entries: [{ c: "NG", peak: 35 }] },
      ...
      { title: "5hrs Till Nairobi", kind: "Singles", entries: [{ c: "NG", peak: 46 }] },
      ...
      { title: "Captain", kind: "Singles", entries: [{ c: "NG", peak: 53 }] },
      ...
      { title: "Cough Syrup", kind: "Singles", entries: [{ c: "NG", peak: 62 }] },
      ...
      { title: "Cutesy", kind: "Singles", entries: [{ c: "NG", peak: 65 }] },
      ...
      { title: "Loose Emotiona", kind: "Singles", entries: [{ c: "NG", peak: 67 }] },
      ...
      { title: "Eleyi", kind: "Singles", entries: [{ c: "NG", peak: 73 }] },

...
export const afrobeatsArtists: AfroArtist[] = [
  {
    ...
    country: "Nigeria",
    flag: "🇳🇬",
    hook: "A hundred and four charted records in Nigeria — second only to Seyi Vibez on this board, and all but one of his chart entries came at home.",
    ...
    charts: [
      ...
      { title: "PonPon", kind: "Singles", cover: "https://cdn-images.dzcdn.net/images/cover/bdfe7c01a5c1aff44cfd2345a67fa4b4/500x500-000000-80-0-0.jpg", entries: [{ c: "NG", peak: 20 }] },
  ...
  },
  {
    ...
    charts: [
      ...
      { title: "System", kind: "Singles", entries: [{ c: "GLBX", peak: 179 }] },
  ...
  },
  {
    ...
    charts: [
      ...
      { title: "Blessings on Blessings (Mayorkun ft. Davido)", kind: "Singles", cover: "https://is1-ssl.mzstatic.com/image/thumb/Music221/v4/30/19/e5/3019e554-4b90-4e17-e9b5-eb3cbe8f8470/196872962963.jpg/300x300bb.jpg", entries: [{ c: "NG", peak: 22, note: "Peak still open — read in the release's first weeks on the Top 100, so it may yet climb. Re-read in a later capture." }] },
      { title: "Magician (Morravey & Davido)", kind: "Singles", cover: "https://cdn-images.dzcdn.net/images/cover/873875519db3872128dde438bde322b1/500x500-000000-80-0-0.jpg", entries: [{ c: "NG", peak: 44, note: "Peak still open — read in the release's first weeks on the Top 100, so it may yet climb. Re-read in a later capture." }] },
      { title: "Sober (Yung Alpha & Davido)", kind: "Singles", cover: "https://cdn-images.dzcdn.net/images/cover/f46ca9a6ec6f7f9593949fa9a8afd4a6/500x500-000000-80-0-0.jpg", entries: [{ c: "NG", peak: 83, note: "Peak still open — read in the release's first weeks on the Top 100, so it may yet climb. Re-read in a later capture." }] },
      { title: "Wallah Wallah (Badshah & Davido)", kind: "Singles", cover: "https://cdn-images.dzcdn.net/images/cover/e58c5871c2ec0d0d867610877614453d/500x500-000000-80-0-0.jpg", entries: [{ c: "NG", peak: 85, note: "Peak still open — read in the release's first weeks on the Top 100, so it may yet climb. Re-read in a later capture." }] },
      { title: "Dodo", kind: "Singles", cover: "https://cdn-images.dzcdn.net/images/cover/ad799330e6b536a01e1c30f5d2d98971/500x500-000000-80-0-0.jpg", entries: [{ c: "NG", peak: 93, note: "Peak still open — read in the release's first weeks on the Top 100, so it may yet climb. Re-read in a later capture." }] },
],
  },
  {
    slug: "rema",
  ...
  },
  {
    ...
    verifiedOn: AFROBEATS_VERIFIED_ON,
    swept: true,
    chartPublished: { entries: 175, territories: 52, no1s: 3 },
    releases: [
  ...
  },
  {
    ...
    verifiedOn: AFROBEATS_VERIFIED_ON_5,
    swept: true,
    chartPublished: { entries: 71, territories: 16, no1s: 6 },
    releases: [
  ...
  },
  {
    ...
    releases: [
      ...
      { title: "Dealer", kind: "Lead singles", cover: "https://cdn-images.dzcdn.net/images/cover/149a623f2423b057b53f3c8082f52464/500x500-000000-80-0-0.jpg", certs: [{ c: "NG", level: "Platinum", x: 5 }] },

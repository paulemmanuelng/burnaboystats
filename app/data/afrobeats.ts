...
export const afrobeatsArtists: AfroArtist[] = [
  ...
  },
  {
    ...
    releases: [
      ...
      { title: "Different Size", kind: "Lead singles", certs: [{ c: "NG", level: "Platinum" }] },
      { title: "Everything (Victony)", kind: "Lead singles", certs: [{ c: "NG", level: "Platinum" }] },
      ...
      { title: "Kolomental", kind: "Lead singles", certs: [{ c: "NG", level: "Platinum" }] },
      { title: "OHEMA", kind: "Lead singles", certs: [{ c: "NG", level: "Platinum" }] },
      { title: "Apollo", kind: "Lead singles", certs: [{ c: "NG", level: "Gold" }] },
      { title: "Babylon", kind: "Featured appearances", certs: [{ c: "NG", level: "Gold" }] },
      ...
      { title: "All Power", kind: "Lead singles", certs: [{ c: "NG", level: "Silver" }] },
      { title: "Ave Maria", kind: "Lead singles", certs: [{ c: "NG", level: "Silver" }] },
      { title: "Cough Syrup", kind: "Lead singles", certs: [{ c: "NG", level: "Silver" }] },
      { title: "Holy Water (Davido)", kind: "Featured appearances", certs: [{ c: "NG", level: "Silver" }] },
      { title: "Ludo", kind: "Lead singles", certs: [{ c: "NG", level: "Silver" }] },
    ...
    charts: [
      ...
      { title: "OHEMA", kind: "Singles", entries: [{ c: "NG", peak: 5 }] },
      { title: "Everything", kind: "Singles", entries: [{ c: "NG", peak: 6 }] },
      ...
      { title: "Different Size", kind: "Singles", entries: [{ c: "NG", peak: 8 }] },
      ...
      { title: "Tanko", kind: "Singles", entries: [{ c: "NG", peak: 15 }] },
      { title: "Skido", kind: "Singles", entries: [{ c: "NG", peak: 16 }] },
      { title: "Kolomental", kind: "Singles", entries: [{ c: "NG", peak: 17 }] },
      { title: "Holy Water", kind: "Singles", entries: [{ c: "NG", peak: 19 }] },
      { title: "Glory", kind: "Singles", entries: [{ c: "NG", peak: 20 }] },
      { title: "Glory II", kind: "Singles", entries: [{ c: "NG", peak: 20 }] },
      { title: "Ludo", kind: "Singles", entries: [{ c: "NG", peak: 21 }] },
      ...
      { title: "Ave Maria", kind: "Singles", entries: [{ c: "NG", peak: 25 }] },
      { title: "Margaret", kind: "Singles", entries: [{ c: "NG", peak: 30 }] },
      { title: "Babylon", kind: "Singles", entries: [{ c: "NG", peak: 35 }] },
      ...
      { title: "Sawa", kind: "Singles", entries: [{ c: "NG", peak: 36 }] },
      { title: "Belle Full", kind: "Singles", entries: [{ c: "NG", peak: 37 }] },
      { title: "My Darling", kind: "Singles", entries: [{ c: "NG", peak: 46 }] },
      ...
      { title: "Anita", kind: "Singles", entries: [{ c: "NG", peak: 63 }] },
      { title: "Obianuju", kind: "Singles", entries: [{ c: "NG", peak: 74 }] },
      { title: "Apollo", kind: "Singles", entries: [{ c: "NG", peak: 82 }] },
      { title: "All Power", kind: "Singles", entries: [{ c: "NG", peak: 83 }] },
      { title: "Ordinary Things", kind: "Singles", entries: [{ c: "NG", peak: 92 }] },
    ],
  },
  {
    slug: "fireboy-dml",
    ...
    releases: [
      ...
      { title: "Dealer", kind: "Lead singles", certs: [{ c: "NG", level: "Platinum", x: 5 }] },
      ...
      { title: "All Of Us (Ashawo)", kind: "Lead singles", certs: [{ c: "NG", level: "Platinum" }] },
      { title: "Everyday (Fireboy Dml)", kind: "Lead singles", certs: [{ c: "NG", level: "Platinum" }] },
      ...
      { title: "Compromise", kind: "Lead singles", certs: [{ c: "NG", level: "Gold" }] },
      { title: "Firegun", kind: "Featured appearances", certs: [{ c: "NG", level: "Gold" }] },
      { title: "Running", kind: "Featured appearances", certs: [{ c: "NG", level: "Gold" }] },
      { title: "Vex For U", kind: "Featured appearances", certs: [{ c: "NG", level: "Gold" }] },
      { title: "Yawa (Fireboy Dml)", kind: "Lead singles", certs: [{ c: "NG", level: "Gold" }] },
      ...
      { title: "Back N Forth", kind: "Lead singles", certs: [{ c: "NG", level: "Silver" }] },
      { title: "Diana", kind: "Lead singles", certs: [{ c: "NG", level: "Silver" }] },
      ...
      { title: "Hell And Back", kind: "Lead singles", certs: [{ c: "NG", level: "Silver" }] },
      { title: "Like I Do", kind: "Lead singles", certs: [{ c: "NG", level: "Silver" }] },
      { title: "Obaa Sima", kind: "Lead singles", certs: [{ c: "NG", level: "Silver" }] },
      { title: "Olufunmi Reimagined", kind: "Lead singles", certs: [{ c: "NG", level: "Silver" }] },
      { title: "Outside (Fireboy Dml)", kind: "Lead singles", certs: [{ c: "NG", level: "Silver" }] },
      { title: "Shibebe", kind: "Lead singles", certs: [{ c: "NG", level: "Silver" }] },
      { title: "Southy Love", kind: "Featured appearances", certs: [{ c: "NG", level: "Silver" }] },
      { title: "Vibration", kind: "Lead singles", certs: [{ c: "NG", level: "Silver" }] },
    ],
    charts: [
      { title: "Bandana", kind: "Singles", cover: "https://cdn-images.dzcdn.net/images/cover/3a0ea8b02098effdf5ecce496d515176/500x500-000000-80-0-0.jpg", entries: [{ c: "NG", peak: 1 }, { c: "ZA", peak: 79 }] },
      { title: "Dealer", kind: "Singles", entries: [{ c: "NG", peak: 2 }] },
      ...
      { title: "Vex For U", kind: "Singles", entries: [{ c: "NG", peak: 9 }] },
      { title: "Everyday", kind: "Singles", entries: [{ c: "NG", peak: 10 }] },
      { title: "FIREGUN", kind: "Singles", entries: [{ c: "NG", peak: 10 }] },
      ...
      { title: "On a Kentro", kind: "Singles", entries: [{ c: "NG", peak: 13 }] },
      { title: "hell and back", kind: "Singles", entries: [{ c: "NG", peak: 13 }] },
      { title: "Innocent", kind: "Singles", entries: [{ c: "NG", peak: 14 }] },
      { title: "Oh My", kind: "Singles", entries: [{ c: "NG", peak: 14 }] },
      { title: "Olufunmi Reimagined", kind: "Singles", entries: [{ c: "NG", peak: 15 }] },
      { title: "Peace By Piece - EP", kind: "Albums", entries: [{ c: "NG", peak: 15 }] },
      { title: "All of Us (Ashawo)", kind: "Singles", entries: [{ c: "NG", peak: 16 }] },
      { title: "Ashawo", kind: "Singles", entries: [{ c: "NG", peak: 16 }] },
      { title: "Angelina", kind: "Singles", entries: [{ c: "NG", peak: 18 }] },
      { title: "Obaa Sima", kind: "Singles", entries: [{ c: "NG", peak: 19 }] },
      { title: "letting go", kind: "Singles", entries: [{ c: "NG", peak: 19 }] },
      { title: "back n forth", kind: "Singles", entries: [{ c: "NG", peak: 22 }] },
      { title: "Compromise", kind: "Singles", entries: [{ c: "NG", peak: 23 }] },
      { title: "Diana", kind: "Singles", entries: [{ c: "NG", peak: 25 }] },
      { title: "Outside", kind: "Singles", entries: [{ c: "NG", peak: 25 }] },
      { title: "Pressure", kind: "Singles", entries: [{ c: "NG", peak: 25 }] },
      ...
      { title: "Someone", kind: "Singles", entries: [{ c: "NG", peak: 29 }] },
      ...
      { title: "wande's bop", kind: "Singles", entries: [{ c: "NG", peak: 31 }] },
      { title: "Elon Musk (Remix)", kind: "Singles", entries: [{ c: "NG", peak: 32 }] },
      { title: "YAWA", kind: "Singles", entries: [{ c: "NG", peak: 32 }] },
      ...
      { title: "Jabo", kind: "Singles", entries: [{ c: "NG", peak: 37 }] },
      { title: "call me", kind: "Singles", entries: [{ c: "NG", peak: 37 }] },
      ...
      { title: "Change", kind: "Singles", entries: [{ c: "NG", peak: 45 }] },
      { title: "Liar", kind: "Singles", entries: [{ c: "NG", peak: 47 }] },
      { title: "Shibebe", kind: "Singles", entries: [{ c: "NG", peak: 48 }] },
      { title: "Hustler", kind: "Singles", entries: [{ c: "NG", peak: 53 }] },
      { title: "ecstasy", kind: "Singles", entries: [{ c: "NG", peak: 58 }] },
      { title: "Adore", kind: "Singles", entries: [{ c: "NG", peak: 63 }] },
      { title: "Nobody", kind: "Singles", entries: [{ c: "NG", peak: 69 }] },
      { title: "Sofri", kind: "Singles", entries: [{ c: "NG", peak: 69 }] },
      { title: "So Much Sense", kind: "Singles", entries: [{ c: "NG", peak: 71 }] },
      { title: "Count On Me", kind: "Singles", entries: [{ c: "NG", peak: 76 }] },
      { title: "One Of A Kind", kind: "Singles", entries: [{ c: "NG", peak: 76 }] },
      { title: "Afro Highlife", kind: "Singles", entries: [{ c: "NG", peak: 80 }] },
      { title: "Timoti", kind: "Singles", entries: [{ c: "NG", peak: 83 }] },
      { title: "Diamonds", kind: "Singles", entries: [{ c: "NG", peak: 87 }] },
      { title: "Ogaranya", kind: "Singles", entries: [{ c: "NG", peak: 95 }] },
      { title: "ready", kind: "Singles", entries: [{ c: "NG", peak: 96 }] },
      { title: "change your life", kind: "Singles", entries: [{ c: "NG", peak: 100 }] },

...
export const metadata = pageMetadata({
  ...
  description:
    "Shakira & Burna Boy's “Dai Dai” — the World Cup anthem: 31 days as Earth's most-streamed song, No. 1 in 27 countries, and the Final halftime show.",
  path: "/dai-dai",
  ...
  const numberGroups: { label: string; intro: string; items: { v: string; l: string }[] }[] = [
    {
      ...
      items: [
        { v: "31 days", l: "in total at No. 1 on Spotify's Global Daily Top Songs chart — a first for an African artist, and reclaimed in August as the longest-running No. 1 by any 2026 release; now tied with Justin Bieber & Nicki Minaj's “Beauty And A Beat” (31) for the second-most days at No. 1 by any song this year, one behind Djo's “End of Beginning” (32); 56 days inside the global Top 10 and 84 days on the chart, all still counting" },

  ...
  const numberGroups: { label: string; intro: string; items: { v: string; l: string }[] }[] = [
    {
      ...
      items: [
        { v: "37 days", l: "in total at No. 1 on Spotify's Global Daily Top Songs chart — a first for an African artist, and the most days at No. 1 by any song in 2026, now five clear of Djo's “End of Beginning” (32) and six of Justin Bieber & Nicki Minaj's “Beauty And A Beat” (31); past 65 days inside the global Top 10 and 93 days on the chart, both still counting" },
    ...
    },
    {
      ...
      items: [
        ...
        { v: "28 days", l: "at No. 1 on Spotify's Global Music Video chart — more than any other song has managed there, and not narrowly: the next-longest run on it is 3 days" },

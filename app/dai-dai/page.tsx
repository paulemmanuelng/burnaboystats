...
export default function DaiDaiPage() {
  ...
  const heroNumbers: { v: string; l: string }[] = [
    ...
    { v: `${daiDaiCertCount}`, l: "certifications — Diamond in France, 2× Platinum (Latin) in the US, Platinum in Spain, Slovakia, Portugal, Hungary, Austria & Greece, Gold in Colombia, the Czech Republic, Italy, Poland & Belgium, and Silver in the UK" },
  ...
  const faqs: { q: string; a: string }[] = [
    ...
    },
    {
      ...
      a: `“Dai Dai” has ${daiDaiCertCount} certifications: Diamond in France from SNEP, 2× Platinum (Latin) in the US from the RIAA, Platinum in Spain, Slovakia, Portugal, Hungary, Austria and Greece, Gold in Colombia, the Czech Republic, Italy, Poland and Belgium, and Silver in the UK from the BPI.`,
    },
  ];

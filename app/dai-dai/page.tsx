...
export default function DaiDaiPage() {
  ...
  const heroNumbers: { v: string; l: string }[] = [
    ...
    { v: `${daiDaiCertCount}`, l: "certifications — Diamond in France, 2× Platinum in Canada, 2× Platino in the US, Platinum in Spain, Slovakia, Portugal, Hungary, Austria, Greece & Sweden, Gold in Colombia, the Czech Republic, Italy, Poland, Belgium & Germany, and Silver in the UK" },

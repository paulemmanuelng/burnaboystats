...
export const metadata = pageMetadata({
  ...
  description:
    "Shakira & Burna Boy's “Dai Dai” — the World Cup anthem: 28 days as Earth's most-streamed song, No. 1 in 27 countries, and the Final halftime show.",
  path: "/dai-dai",
...
export default function DaiDaiPage() {
  ...
  const heroNumbers: { v: string; l: string }[] = [
    ...
    { v: DAI_DAI_SPOTIFY_STREAMS, l: "Spotify streams — his 8th song past 300 million, the most of any African act, after 28 days as the most-streamed song on Earth" },
  ...
  const numberGroups: { label: string; intro: string; items: { v: string; l: string }[] }[] = [
    {
      ...
      items: [
        { v: "28 days", l: "in total at No. 1 on Spotify's Global Daily Top Songs chart — a first for an African artist, and reclaimed in August as the longest-running No. 1 by any 2026 release, past BTS' “Swim” (25); 53 days inside the global Top 10 and 81 days on the chart, all still counting" },

...
export default function DaiDaiPage() {
  ...
  const byNumbers: { v: string; l: string }[] = [
    ...
    { v: "16 days", l: "at No. 1 on Spotify's Global Daily Top Songs chart, plus a 2nd week atop the Weekly chart — the most-streamed song on Earth, a first for an African artist" },

...
export default function DaiDaiPageES() {
  ...
  const heroNumbers: { v: string; l: string }[] = [
    ...
    { v: `${daiDaiCertCount}`, l: "certificaciones — diamante en Francia, doble platino (latino) en EE. UU., platino en España, Eslovaquia, Portugal, Hungría, Austria y Grecia, oro en Colombia, Chequia, Italia, Polonia y Bélgica, y plata en el Reino Unido" },
  ...
  const faqs: { q: string; a: string }[] = [
    ...
    },
    {
      ...
      a: `“Dai Dai” tiene ${daiDaiCertCount} certificaciones: diamante en Francia por la SNEP, doble platino (latino) en Estados Unidos por la RIAA, platino en España, Eslovaquia, Portugal, Hungría, Austria y Grecia, oro en Colombia, Chequia, Italia, Polonia y Bélgica, y plata en el Reino Unido por la BPI.`,
    },
    {

...
export const metadata = pageMetadata({
  ...
  description:
    "“Dai Dai”, de Shakira y Burna Boy: 31 días como la canción más escuchada del mundo, número 1 en 27 países y el show de medio tiempo de la Final del Mundial.",
  path: ES_PATH,
...
export default function DaiDaiPageES() {
  ...
  const steps: Step[] = [
    ...
    },
    {
      ...
      body: "“Dai Dai” lideró la lista Global Top Songs de Spotify tanto en su versión diaria como en la semanal: 31 días como la canción más escuchada del mundo, una racha recuperada en agosto, y la primera vez que un artista africano la encabeza.",
    },
    {
      scene: "certs",
      kicker: "Certificada en el mundo entero",
      title: "Llegaron los discos",
      body: `La canción ganó sus propias certificaciones: doble platino (latino) en Estados Unidos, platino en España, Francia, Eslovaquia, Portugal y Hungría, oro en Colombia, Grecia y Chequia, y plata en el Reino Unido. Ya son ${daiDaiCertCount} certificaciones para la colaboración de Shakira y Burna Boy, y siguen sumando.`,
    },
    {
      scene: "worldsong",
      kicker: "El récord",
  ...
  const heroNumbers: { v: string; l: string }[] = [
    ...
    { v: DAI_DAI_SPOTIFY_STREAMS, l: "reproducciones en Spotify — la octava canción de Burna Boy que supera los 300 millones, más que ningún otro artista africano, tras 31 días como la canción más escuchada del planeta" },
    { v: `${daiDaiCertCount}`, l: "certificaciones — doble platino (latino) en EE. UU., platino en España, Francia, Eslovaquia, Portugal y Hungría, oro en Colombia, Grecia y Chequia, y plata en el Reino Unido" },
  ...
  const numberGroups = [
    {
      ...
      items: [
        { v: "31 días", l: "en total en el número 1 de la lista Global Daily Top Songs de Spotify —algo inédito para un artista africano, y recuperado en agosto como la racha más larga de cualquier lanzamiento de 2026—; ahora empatada con “Beauty And A Beat” de Justin Bieber y Nicki Minaj (31) como la segunda canción con más días en el número 1 de cualquier canción este año, a uno de “End of Beginning” de Djo (32); 56 días dentro del top 10 mundial y 84 en la lista" },
    ...
    },
    {
      ...
      items: [
        ...
        { v: "9 semanas", l: "en el número 1 de la lista oficial de Suiza — la racha más larga de cualquier canción en el país en lo que va de año" },
        { v: "5 semanas", l: "en el número 1 de la lista oficial de sencillos de Francia (SNEP)" },
    ...
    },
    {
      ...
      items: [
        { v: "7 semanas", l: "en el número 1 del United World Chart de Mediatraffic — 347.000 puntos en la semana del 15 de agosto, y la primera canción de Burna Boy que lo lidera" },
        { v: "N.º 1", l: "en la lista de canciones de iTunes en 72 países — Estados Unidos, Reino Unido, Canadá, Francia, Italia, Nueva Zelanda, India, España, Portugal, Hungría y decenas más" },
        { v: "N.º 13", l: "en el Deezer Worldwide Top 100 — un nuevo pico, con presencia en 57 países y el número 1 en 23 de ellos" },
        { v: "17 días", l: "en el número 1 de la lista Global Music Video de Spotify — más que cualquier otra canción en esa lista" },
  ...
  const faqs: { q: string; a: string }[] = [
    ...
    },
    {
      ...
      a: "“Dai Dai” tiene 10 certificaciones: doble platino (latino) en Estados Unidos por la RIAA, platino en España, Francia, Eslovaquia, Portugal y Hungría, oro en Colombia, Grecia y Chequia, y plata en el Reino Unido por la BPI.",
    },
    {
      ...
      <div className={styles.wrap}>
        <DaiDaiStory
          ...
          sceneCopy={{
            ...
            streamingNote: "Diaria y semanal · 31 días como la canción más escuchada del mundo",

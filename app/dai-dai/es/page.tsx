...
export const metadata = pageMetadata({
  ...
  description:
    "“Dai Dai”, de Shakira y Burna Boy: 28 días como la canción más escuchada del mundo, número 1 en 27 países y el show de medio tiempo de la Final del Mundial.",
  path: ES_PATH,
...
export default function DaiDaiPageES() {
  ...
  const steps: Step[] = [
    ...
    },
    {
      ...
      body: "“Dai Dai” lideró la lista Global Top Songs de Spotify tanto en su versión diaria como en la semanal: 28 días como la canción más escuchada del mundo, una racha recuperada en agosto, y la primera vez que un artista africano la encabeza.",
    },
    {
      scene: "certs",
  ...
  const numberGroups = [
    {
      ...
      items: [
        { v: "28 días", l: "en total en el número 1 de la lista Global Daily Top Songs de Spotify —algo inédito para un artista africano, y recuperado en agosto como la racha más larga de cualquier lanzamiento de 2026, por delante de “Swim” de BTS (25)—; 53 días dentro del top 10 mundial y 81 en la lista" },
      ...
      <div className={styles.wrap}>
        <DaiDaiStory
          ...
          sceneCopy={{
            ...
            streamingNote: "Diaria y semanal · 28 días como la canción más escuchada del mundo",

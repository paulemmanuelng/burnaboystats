...
export const faqs: { g: GroupId; q: string; a: string }[] = [
  ...
  },
  {
    ...
    a: `Burna Boy was the first African artist to headline a FIFA World Cup opening ceremony and the first to perform at a World Cup Final halftime show (both 2026), the first to sell out a stadium in the United States (Citi Field, 2023) and to headline a UK stadium (London Stadium, 2023), and one of two African artists past a billion UK streams (a BRIT Billion award, 2024).`,
  },
  {
    g: "cars",

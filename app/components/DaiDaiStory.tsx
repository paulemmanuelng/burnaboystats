...
const EN_SCENE: SceneCopy = {
  ...
  streamingNote: "Daily & Weekly · 34 days as Earth's most-streamed song",
...
function buildSteps(p: Props): Step[] {
  return [
    ...
    },
    {
      ...
      body: "“Dai Dai” topped Spotify's Global Top Songs chart on both the Daily and Weekly lists — 34 days as the single most-streamed song on the planet, a run reclaimed in August, and the first time an African artist has ever led it.",
    },
    {
      scene: "certs",
      kicker: "Certified worldwide",
      title: "The plaques rolled in",
      body: `The song earned its own plaques — 2× Platinum (Latin) in the US, Platinum in Spain, France, Slovakia, Portugal and Hungary, Gold in Colombia, Greece, the Czech Republic and Italy, and Silver in the UK. ${p.daiDaiCerts} certifications for Shakira and Burna Boy's collaboration, and counting.`,
    },
    {
      scene: "worldsong",
      kicker: "The record",

...
export const searchIndex: SearchDoc[] = [
  ...
  },
  {
    ...
    section: "Afrobeats",
    description: "24 certifications and 22 official chart entries, verified at source — the only Ghanaian on the board.",
  ...
  },
  {
    ...
    section: "Afrobeats",
    description: "Every official chart peak for Black Sherif — 22 entries, with “Kwaku the Traveller” at No. 1 in Nigeria.",
  ...
  },
  {
    ...
    path: "/afrobeats/bnxn",
    section: "Afrobeats",
    description: "65 certifications across 6 countries and 103 official chart entries, verified at source.",
  ...
  },
  {
    ...
    section: "Afrobeats",
    description: "Every official chart peak for BNXN — 103 entries across 7 territories, 7 of them No. 1 in Nigeria.",

...
export const searchIndex: SearchDoc[] = [
  ...
  {
    title: "Kilometre",
    path: "/music/kilometre",
    section: "Song",
    description: "Burna Boy's “Kilometre” (2021) — No. 1 in Nigeria, Platinum, his first solo single after Twice as Tall.",
    keywords: ["kilometre", "kilometer", "song", "2021", "nigeria", "platinum", "turntable"],
  },
  {
    title: "City Boys",
